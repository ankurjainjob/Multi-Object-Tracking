...
[hypothesesWeight_hat, multiHypotheses_hat] = hypothesisReduction.prune(hypothesesWeight, multiHypotheses, threshold); 

hypothesesWeight_hat = sort(hypothesesWeight_hat);

% Run reference solution.
[hypothesesWeight_hat_ref, multiHypotheses_hat_ref] = reference.hypothesisReduction.prune(hypothesesWeight, multiHypotheses, threshold); 
