...
gating.P_G = P_G;
gating.size = chi2inv(gating.P_G,meas_model.d);
...
%One step update
PPP = update(PPP,measdata{1},meas_model,sensor_model.intensity_c,P_D,gating);
...
%One step update
PPP_ref = update(PPP_ref,measdata{1},meas_model,sensor_model.intensity_c,P_D,gating);
